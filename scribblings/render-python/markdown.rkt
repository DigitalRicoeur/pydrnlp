...
;; This file is forked from the markdown/scrib
;; module of Greg Hendershott's markdown package.
;; The upstream version is MIT-licensed and canonically
;; lives at https://github.com/greghendershott/markdown/
...
(provide
 (contract-out
  [rename xs->ps xexprs->scribble-pres
          (->* [(listof xexpr?)]
               [(-> xexpr?
                    (or/c #f pre-part? pre-flow? pre-content?))]
